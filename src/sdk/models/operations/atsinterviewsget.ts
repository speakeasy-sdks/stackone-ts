...
export class AtsInterviewsGetRequest extends SpeakeasyBase {
    /**
...
export class AtsInterviewsGetResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    interviewsResult?: shared.InterviewsResult;
