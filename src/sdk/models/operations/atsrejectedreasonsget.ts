...
export class AtsRejectedReasonsGetRequest extends SpeakeasyBase {
    /**
...
export class AtsRejectedReasonsGetResponse extends SpeakeasyBase {
    @SpeakeasyMetadata()
    contentType: string;
     ...
     */
    @SpeakeasyMetadata()
    rejectedReasonResult?: shared.RejectedReasonResult;
