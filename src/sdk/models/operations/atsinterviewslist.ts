...
export class AtsInterviewsListRequest extends SpeakeasyBase {
    /**
...
export class AtsInterviewsListResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    interviewsPaginated?: shared.InterviewsPaginated;
