...
export class AtsInterviewStagesGetRequest extends SpeakeasyBase {
    /**
...
export class AtsInterviewStagesGetResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    interviewStageResult?: shared.InterviewStageResult;
