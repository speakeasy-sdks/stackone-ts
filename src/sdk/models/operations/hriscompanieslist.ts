...
export class HrisCompaniesListRequest extends SpeakeasyBase {
    /**
...
export class HrisCompaniesListResponse extends SpeakeasyBase {
    /**
     * The list of Companies was retrieved.
     */
    @SpeakeasyMetadata()
    companiesPaginated?: shared.CompaniesPaginated;
