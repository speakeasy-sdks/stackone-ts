...
export class MarketingOmniChannelTemplatesListRequest extends SpeakeasyBase {
    /**
...
export class MarketingOmniChannelTemplatesListResponse extends SpeakeasyBase {
    /**
