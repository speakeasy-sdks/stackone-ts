...
export class HrisEmploymentsGetRequest extends SpeakeasyBase {
    /**
...
export class HrisEmploymentsGetResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    employmentResult?: shared.EmploymentResult;
