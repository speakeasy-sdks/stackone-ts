...
export class HrisLocationsListRequest extends SpeakeasyBase {
    /**
...
export class HrisLocationsListResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    locationsPaginated?: shared.LocationsPaginated;
