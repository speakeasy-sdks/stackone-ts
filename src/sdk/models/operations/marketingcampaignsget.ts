...
export class MarketingCampaignsGetRequest extends SpeakeasyBase {
    /**
...
export class MarketingCampaignsGetResponse extends SpeakeasyBase {
    /**
     * The campaign with the given identifier was retrieved.
     */
    @SpeakeasyMetadata()
    campaignResult?: shared.CampaignResult;
