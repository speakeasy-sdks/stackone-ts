...
export class MarketingCampaignsListRequest extends SpeakeasyBase {
    /**
...
export class MarketingCampaignsListResponse extends SpeakeasyBase {
    /**
     * The list of campaigns was retrieved.
     */
    @SpeakeasyMetadata()
    campaignsPaginated?: shared.CampaignsPaginated;
