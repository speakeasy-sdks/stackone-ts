...
export class HrisEmployeesListRequest extends SpeakeasyBase {
    /**
...
export class HrisEmployeesListResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    employeesPaginated?: shared.EmployeesPaginated;
