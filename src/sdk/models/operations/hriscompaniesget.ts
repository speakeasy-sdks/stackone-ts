...
export class HrisCompaniesGetRequest extends SpeakeasyBase {
    /**
...
export class HrisCompaniesGetResponse extends SpeakeasyBase {
    /**
     * The Company with the given identifier was retrieved.
     */
    @SpeakeasyMetadata()
    companyResult?: shared.CompanyResult;
